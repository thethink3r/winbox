...
export WINBOX_DOWNLOAD_URL='https://download.mikrotik.com/winbox/3.38/winbox64.exe'
...
echo "\$1: '$1' \$2: '$2'"
if [ -f "/app/wine-breeze-dark.reg" ]; then
    "${WINE}" regedit /app/wine-breeze-dark.reg
fi
